...
from strategies.smc_v1 import STRATEGY_ID, add_daily_indicators, add_entry_indicators
...
def print_sensitivity_report(results: list[dict]) -> None:
    ...
    print("\nSENSITIVITY ANALYSIS REPORT — NAS100 / US30")
    print("==============================================")
    print("\nBY FILTER COUNT:")
